...
import com.eziamtech.malwapathshala.Adapter.WithdrawHistoryAdapter;
import com.eziamtech.malwapathshala.Model.ProfileModel.ProfileModel;
import com.eziamtech.malwapathshala.Model.WithdrawalModel.Result;
...
public class WithdrawHistory extends AppCompatActivity {
    ...
    List<com.eziamtech.malwapathshala.Model.ProfileModel.Result> profileList;
                ...
                try {
                    if (response.code() == 200 && response.body().getStatus() == 200) {
                        ...
                        if (response.body().getResult().size() > 0) {
                            profileList = new ArrayList<com.eziamtech.malwapathshala.Model.ProfileModel.Result>();
