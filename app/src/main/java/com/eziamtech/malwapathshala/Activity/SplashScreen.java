...
import com.eziamtech.malwapathshala.Util.ConnectivityReceiver;
import com.eziamtech.malwapathshala.Util.Constant;
import com.eziamtech.malwapathshala.Util.MyApp;
...
public class SplashScreen extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    private void printKeyHash() {
        ...
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.divinetechs.quizapp", PackageManager.GET_SIGNATURES);
